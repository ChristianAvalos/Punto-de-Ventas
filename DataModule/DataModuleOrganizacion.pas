...
uses
  SysUtils, Classes, Data.DB, MemDS, DBAccess, MSAccess, VirtualTable;
...
type
  TDMOrganizacion = class(TDataModule)
    ...
    VTOrganizacionLogo: TVirtualTable;
    VTOrganizacionLogoLogoBMP: TBlobField;
    DSOrganizacionLogo: TDataSource;
    MSOrganizacionLogo: TMSQuery;
    MSOrganizacionLogoLogotipo: TBlobField;
    ...
    procedure MSOrganizacionLogoAfterPost(DataSet: TDataSet);
  private
...
uses
  UniGUIVars, uniGUIMainModule, MainModule, UnitValidaciones, UnitRecursoString, FormularioOrganizacion, UnitCodigosComunesFormulario, DataModulePrincipal, UnitOperacionesFotografia;
...
procedure TDMOrganizacion.MSOrganizacionLogoAfterPost(DataSet: TDataSet);
begin
  RecuperarFoto(MSOrganizacionLogo, 'Logotipo', VTOrganizacionLogo, 'LogoBMP', MSOrganizacionIdOrganizacion.Value);
end;
