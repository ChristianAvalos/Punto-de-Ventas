...
resourcestring
  ...
  EEscribaContrasena = 'Escriba una contraseña';
  EPasswordNoCoincide = 'Las contraseñas no coinciden';
  EPasswordActualNoCoincide = 'La contraseña actual es incorrecta';
  EPasswordCambiadoExito = 'Contraseña cambiado con éxito';

  EContrasenaoUsuarioIncorrecta = 'Usuario o Contraseña incorrecta';
  EContrasenaMedianteLDAP = 'La contraseña debe cambiarse mediante LDAP / AD';
  EAutoservicioMedianteLDAP = 'El autoservicio se autentica mediante LDAP / AD';
  ESoloPuedeCambiarContrasenaUsuarioActivo = 'Sólo se puede cambiar contraseña de usuarios activos';
  ...
  EIPNovalido = 'Escriba una IP válida';
  ENoPuedeAccederAlmacen = 'No posee acceso a este almacén';
  EUsuarioInvalidoNoExiste = 'No existe Usuario o es inválido';
  ...
  EExistePersonalDocumento = 'Ya existe un personal con ese Número de Documento';
  EExistePersonalLegajoNro = 'Ya existe un personal con ese Número de Legajo';
  ...
  ESeleccioneModulo = 'Seleccione el módulo';
  EEscribaPass = 'Escriba la contraseña';
  ESeleccioneFecha = 'Seleccione Fecha';
  EDeseaCancelarOperacion = 'Desea cancelar la operación';
